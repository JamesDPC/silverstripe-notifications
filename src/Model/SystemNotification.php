...
class SystemNotification extends DataObject implements PermissionProvider
{
     ...
     */
    public function format(string $text, DataObject $context, object $user, array $extraData = []): string
    {
     ...
     * @param object $user see NotifiedOn::getRecipients for documentation
     */
    public function getTemplateData(DataObject $context, object $user, array $extraData = []): ArrayData
    {
        // useful global data
        $data = [
        ...
        // the user the notification is being sent to
        $data['Member'] = $user;
